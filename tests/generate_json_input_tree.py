...
# Number of tasks
N_TASKS = [
    10, 25, 50, 75, 100, 125, 150, 250, 500, 750, 1000,
...
def generate_file_name(n_bins, n_goals, n_tasks, years):
    return f"{n_bins}_bins_{n_goals}_goals_{n_tasks}_tasks_{years}_years.json"
